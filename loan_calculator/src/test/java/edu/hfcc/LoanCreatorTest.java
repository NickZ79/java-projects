...
public class LoanCreatorTest {
    ...
    // Match the exact line breaks used in Loan.buildOutput()
    ...
    public void verifyLoanWithLoanAmountPassedIn() {
        ...
        String actual = loanCreator.execute("John", "Doe", 40000, null, null);
    ...
    public void verifyLoanWithLoanAmountAndTermPassedIn() {
        ...
        String actual = loanCreator.execute("Sally", "Freedom", 40000, 24, null);
    ...
    public void verifyLoanWithLoanAmountAndInterestRatePassedIn() {
        ...
        String actual = loanCreator.execute("Denny", "Cool", 40000, null, 4.3);
